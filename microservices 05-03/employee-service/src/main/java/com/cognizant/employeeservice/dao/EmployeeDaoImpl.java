...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public Employee getEmployeeById(int emp_id) {
		...
		Employee employee = employeeRepository.findById(emp_id).<EmployeeNotFoundException>orElseThrow(() -> {throw new EmployeeNotFoundException();});
		return employee;
	}
	...
	public Employee updateEmployeeDetails(int emp_id, Employee employee) {
		// TODO Auto-generated method stub
		Employee employeeFound = employeeRepository.findById(emp_id).<EmployeeNotFoundException>orElseThrow(() -> {throw new EmployeeNotFoundException();});
